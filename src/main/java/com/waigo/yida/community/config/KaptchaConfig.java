...
public class KaptchaConfig {
    ...
    public Producer getKaptchaBeanMath()
    {
        DefaultKaptcha defaultKaptcha = new DefaultKaptcha();
        Properties properties = new Properties();
        // 是否有边框 默认为true 我们可以自己设置yes，no
        ...
        // 验证码文本生成器
        properties.setProperty(KAPTCHA_TEXTPRODUCER_IMPL, "com.waigo.yida.community.config.KaptchaTextCreator");
        // 验证码文本字符间距 默认为2
